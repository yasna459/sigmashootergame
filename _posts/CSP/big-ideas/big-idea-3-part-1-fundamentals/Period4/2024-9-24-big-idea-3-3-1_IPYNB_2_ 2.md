...
<button class="toggle-button" onclick="toggleOutput()">Show Output</button>
<div class="output-container" id="outputContainer" style="display: none;">
    <pre>True, 10 exists at index 4</pre>
</div>
...
<script>
    function toggleOutput() {
        ...
        if (outputContainer.style.display === "none") {
            ...
            document.querySelector(".toggle-button").textContent = "Hide Output";
        } else {
            outputContainer.style.display = "none";
            document.querySelector(".toggle-button").textContent = "Show Output";
        }
    }
</script>
...
<button class="toggle-button1" onclick="toggleOutput1()">Show Output</button>
<div class="output-container1" id="outputContainer1" style="display: none;">
    <pre>Step 1: Preheat Oven.
...
<script>
    function toggleOutput1() {
        ...
        if (outputContainer1.style.display === "none") {
            outputContainer1.style.display = "block";
            document.querySelector(".toggle-button1").textContent = "Hide Output";
        } else {
            outputContainer1.style.display = "none";
            document.querySelector(".toggle-button1").textContent = "Show Output";
        }
    }
</script>
...
<button class="toggle-button2" onclick="toggleOutput2()">Show Output</button>
<div class="output-container2" id="outputContainer2" style="display: none;">
    <pre>
15
5
50
...
<script>
    function toggleOutput2() {
        var outputContainer2 = document.getElementById("outputContainer2");
        if (outputContainer2.style.display === "none") {
            outputContainer2.style.display = "block";
            document.querySelector(".toggle-button2").textContent = "Hide Output";
        } else {
            outputContainer2.style.display = "none";
            document.querySelector(".toggle-button2").textContent = "Show Output";
        }
    }
</script>
...
Example: Applying the order of operations in Python expressions (parentheses first, then other operations).
